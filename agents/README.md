...
- `analysis_agent/`: LangGraph-powered audit and analysis agent
...
Run a single analysis-agent pass for a conversation:

```powershell
..\.venv\Scripts\python -m agents.analysis_agent.cli --conversation-id demo-1
```
